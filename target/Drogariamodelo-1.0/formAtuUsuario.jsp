...
<html>
    <head>
        ...
        <title>Atualizar perfil de ${usuario.nome}</title>
    ...
    <body>
        ...
        <div id="conteudo">
            ${mensagem}
            <div id class="titulo"><a href="index.jsp">Drogaria Pharmaluci</a> - <a href="logadoGerente.jsp">Início</a> - <a href="#"><b>Atualizando Perfil do(a) ${usuario.nome}</b></a></div>
            <div id="ajusteRegistro">
                <form name="form1"  action="UsuarioServlet?cmd=atualizarPerfilUsuario" method="post">
                    <br>
                    ...
                    <div id="ajustePlace1"><input  name="nome" required pattern="[A-z/s]+$" title="Apenas Letras" maxlength="50" value="${usuario.nome}" placeholder="Nome" style=" position:relative; left:0%; width: 50%; height: 30px;" ></div><br>

                    <div id="ajustePlace2"><input  name="sobrenome" pattern="[A-z/s]+$" title="Apenas Letras" maxlength="50" placeholder="Sobrenome" value="${usuario.sobrenome}"style=" position:relative; left:0%; width: 50%; height: 30px;" ></div>

                    <div id="ajustePlace3">
                        <font>Nascimento</font><br>
                        <input type="date" name="dataNascimento" pattern="[0-9][0-9][0-9][0-9]-[0-9][0-9]-[0-9][0-9]" title="Informe uma data válida. Ex: 2016-10-10" placeholder="ex: 2015-08-09"value="${usuario.dataNascimento}" maxlength="10" style=" position:relative; left:0%; width: 50%; height: 30px;"></div>
                    ...
                    <div id="ajustePlace5"><font  >Nome de Login</font><br>
                        <input  name="login" placeholder="Nome de Login" value="${usuario.login}" style=" position:relative; left:0%; width: 50%; height: 30px;"></div>

                    <div id="ajustePlace6"><font >Email</font><br>
                        <input type="email" name="email" placeholder="Nome@tipo.com" value="${usuario.email}" maxlength="45" style="position:relative; left:0%; width: 50%; height: 30px;" >
                    </div>
                    ...
                    <div id="ajustePlace8"><font >CEP</font><br>
                        <input name="cep" placeholder="CEP" pattern="[0-9][0-9].[0-9][0-9][0-9]-[0-9][0-9][0-9]" title="Informe um CEP válido. Ex: 11.123-456"
                    ...
                    <div id="ajustePlace9">
                        <select name="cidade" style=" position:relative; left:0%; width: 50%; height: 30px;" >
                            ...
                            <option value="ParkWay">ParkWay</option>
                             <option value="Qs10">Qs10</option>
                            <option value="Qs11">Qs11</option>
                            <option value="RiachoFundoI">Riacho Fundo I</option>
                            <option value="Sha">Setor Habitacional Arniqueiras</option>
...
<!--<select name="cidade"><script>MontaCidadesUsuario(${usuario.cidade},this);</script></select>-->
                    ...
                    <div id="ajustePlace10"> 
                        Endereço<br>
                        <input name="endereco" required value="${usuario.endereco}" placeholder="Endereço" value="${usuario.endereco}" style=" position:relative; left:0%; width: 50%; height: 30px;">
                    </div> 
                    <input type="hidden" name="tipo" value="1" readonly="readonly" /><br>                    
