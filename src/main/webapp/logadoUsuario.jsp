...
<html>
    <head>
        ...
        <title>Página do(a) ${user.nome}</title>
    ...
    <body>
        ...
        <div id="conteudo">
            ...
            <font style="float: left; margin-top: 8.2%; margin-left: 18%;  font-size: 12pt; text-transform: uppercase; color: black;" >
                <center><b>Bem Vindo! ${user.nome}.<p> 
                        Este é o seu ambiente em que você pode realizar as operações disponibilizadas pelo menu logo acima.</b>
                </center><br>
            </font>

        </div>
        <div id="rodape" style="min-height: 344px">
            <div class="table">
                <h3> Menu</h3>
