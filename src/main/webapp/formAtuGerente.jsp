...
<html>
    <head>
        ...
        <title>Atualizar perfil do(a) ${gerente.nome}</title>
    ...
    <body>
        ...
        <div id="conteudo">
            <div id class="titulo" style="width: auto"><a href="index.jsp">Drogaria Pharmaluci</a> - <a href="logadoGerente.jsp">Início</a> - <a href="#"><b>Atualizar Perfil do(a) ${gerente.nome}</b></a></div>
            <div id="ajusteRegistro">
                <form name="form1"  action="UsuarioServlet?cmd=atualizarGerente" method="post">
                    <br>
                    <font style=" position: relative;  font-family: Tahoma;  font-size:14pt; color:#de313f;"><center><b>Edição de Perfil</b></center></font><br>
                    <!--Puxando o IdUsuario para que ele não possa digitar, facilitando o processo. -->
                    <input type="hidden" name="idUsuario" value="${usuario.idUsuario}" readonly="readonly" />

                    <div id="ajustePlace1"><input  name="nome" required  pattern="[A-z\s]+$" title="Apenas Letras" value="${usuario.nome}" placeholder="Nome" style=" position:relative; left:0%; width: 50%; height: 30px;"></div><br>

                    <div id="ajustePlace2"><input  name="sobrenome"  pattern="[A-z\s]+$" title="Apenas Letras" maxlength="40" placeholder="Sobrenome" required value="${usuario.sobrenome}"style=" position:relative; left:0%; width: 50%; height: 30px;" ></div>

                    <div id="ajustePlace3">
                        <font> Nascimento</font><br>
                        <input type="date" name="dataNascimento"  pattern="[0-9][0-9][0-9][0-9]-[0-9][0-9]-[0-9][0-9]+$" title="Informe uma data válida. Ex: 2015-05-05" placeholder="ex: 2015-08-09" value="${usuario.dataNascimento}" maxlength="10" style=" position:relative; left:0%; width: 50%; height: 30px;"></div>


                    <div id="ajustePlace4"> <font>CPF</font><br><input name="cpf"  required value="${usuario.cpf}" placeholder="CPF" onBlur="javascript: validarCPF(this.value);"
                                                                           onKeyPress="javascript: mascara(this, cpf_mask);" maxlength="14"  style=" position:relative; left:0%; width: 50%; height: 30px;"></div>

                    <div id="ajustePlace5"><font >Login</font><br>
                        <input  name="login" placeholder="Nome de Login" maxlength="35" value="${usuario.login}" style=" position:relative; left:0%; width: 50%; height: 30px;"></div>

                    <div id="ajustePlace6"><font >Email</font><br>
                        <input type="email" name="email" placeholder="Nome@tipo.com" maxlength="50" value="${usuario.email}" style="position:relative; left:0%; width: 50%; height: 30px;" >
                    </div>

                    
                    <div id="ajustePlace7"><font >Senha</font><br>
                        <input type="password" name="senha"  required value="${usuario.senha}" placeholder="Senha"  style=" position:relative; left:0%; width: 50%; height: 30px;">
                    </div>

                    
                    <div id="ajustePlace8"><font >CEP</font><br>
                        <input name="cep" placeholder="CEP" pattern="[0-9][0-9].[0-9][0-9][0-9]-[0-9][0-9][0-9]+$" title="Informe um CEP válido. Ex: 12.345-678"
                               maxlength="10" onBlur="ValidaCep(form1.cep);"  OnKeyPress="formatar('##.###-###', this)" value="${usuario.cep}" style=" position:relative; left:0%; width: 50%; height: 30px;">
                    ...
                    <div id="ajustePlace9">
                        <select name="cidade" style=" position:relative; left:0%; width: 50%; height: 30px;" >
                            <option value="${usuario.cidade}" selected="true">${usuario.cidade}</option>
                            <option value="Ceilândia">Ceilândia</option>
                            <option value="Brasilia">Brasília</option>
                            <option value="Aguas claras">Aguas cláras</option>
...
<!--<select name="cidade"><script>MontaCidadesUsuario(${usuario.cidade},this);</script></select>-->



                    <div id="ajustePlace10"> <input name="endereco" required value="${usuario.endereco}" placeholder="Endereço" value="${usuario.endereco}" style=" position:relative; left:0%; width: 50%; height: 30px;">
                    </div>



                    <input type="hidden" name="tipo" value="2" readonly="readonly" /><br>
