    ...
    <body>
        ...
        <div id="topo">
            ...
            <c:if test="${gerente != null}">
                <c:redirect url="logadoGerente.jsp"/>
            </c:if>
            <a href="farmacia.jsp" title="Onde estamos"><div id class="iconeTopo" style="background-image: url('imagem/localizacao.png'); "></div><div id class="textoIcone"><font color="white">Localização</font></div></a>
                ...
                <a href="entrar.jsp" title="Acesse sua conta"><div id class="iconeTopo" style="background-image: url('imagem/usuario.png'); margin-left: 0.7%"></div><div id class="textoIcone" style="margin-left: 0.3%;"><font color="white">Entrar</font></div></a>
                        ...
                        <c:if test="${user != null}">
                <div id class="iconeTopo" style="background-image: url('imagem/usuario2.png'); margin-left: 0.7%"></div><div id class="textoIcone" style="margin-left: 0.3%;"><font color="white">Olá!</font> (<a href="UsuarioServlet?cmd=procuraUsuarioPerfil&idUsuario=${user.idUsuario}"><font color="white"><b>${user.nome}</b></font></a> |<a href="UsuarioServlet?cmd=sair"> <font color="white"><b>Sair</b></font></a>)</a></div>
        ...
        <div id="conteudo">
            ${mensagemErro}
            <div id class="titulo" style="margin-top: 4%">
                <a href="index.jsp">Drogaria Pharmaluci</a> -<a href="#ajusteEntrar"> <b>Entrar</b> - <b>Cadastro</b></a>
            </div>

            <form method="POST" action="ValidaServlet">
                <div id="ajusteEntrar"><br>
                    <font style="position: relative; font-size: 12pt; text-transform:uppercase; color:#de313f; top:0%; left:0;"><center>Acesse Sua conta</center></b></font><br>

                    <div id="iconeUsuario"></div><br>
                    <input  type ="text" name="login" required value="${usuario.login}" style=" position: relative; top:1%; width: 50%; height:40px;" placeholder=" Nome de Login" ><br>
                    ...
                    <input type="submit"  value="Entrar" style="position:relative; margin-top:7%; left:33%;"><br><br>


                    <font style=" position:relative;  "><a href="entrar.jsp"><center><h3><font color="red">&raquoCriar conta</font></h3></center></a></font>
            ...
            <div id="ajusteRegistro2">
                <form name="form1"  action="UsuarioServlet?cmd=adc2" method="POST">
                    <br>
                    <font style=" position: relative; text-transform: uppercase;  font-size:14pt; color:#de313f;"><center>Cadastro</center></font><br>
                    ...
                    <div id="ajustePlace3"> <font style="font-family: fantasy;">Nascimento</font><br>
