...
<html>
    ...
    <body>
        ...
        <div id="conteudo" >
            <div id class="titulo"style="margin-top: 3.3%;"><a href="index.jsp">Drogaria Pharmaluci</a> - <a href="logadoGerente.jsp">Início</a> - <a href="#"><b>Cadastrando Produto</b></a></div>
            <div id="ajusteRegistro">
                <form name="form1"  action="ProdutoServlet?cmd=adc" method="post">
                    <br>
                    <font style=" position: relative;  text-transform: uppercase; font-size:14pt; color:#de313f;"><center><b>Inserindo Produto</b></center></font><br>
                    <center><a href='imagem/explicacao.png' style='text-decoration: none;'><div class="imgCadastro" title='Ver imagem Descritiva'>Para inserir uma imagem você deve informar os campos abaixo e clicar em Cadastrar, após isso, coloque o nome da imagem baixada de acordo com o número gerado na Img da tabela do produto cadastrado.<p>
                            Ex:<font style="text-transform: lowercase"> 2.jpg</font> </div></a></center><br>
                    <div id="ajustePlace1"><input  name="nome" required  placeholder=" Nome" required style=" position:relative; left:0%; width: 50%; height: 30px;" ></div><br>

                    <div id="ajustePlace2">
                        <textarea  name="descricao" placeholder=" Descrição Resumida" style="position:relative; left:0%; max-width: 50%; min-width: 50%; max-height: 160px;" ></textarea></div><br>
                        <div id="ajustePlace2">
                             <textarea  name="descricaoCompleta" placeholder=" Bula do Medicamento, senão for um medicamento insira uma descrição" style="position:relative; left:0%; max-width: 50%; min-width: 50%; max-height: 160px;" ></textarea></div><br>
                        
                        <div id="ajustePlace3">
                           <input  name="precoAntigo" placeholder=" Preco Atual" pattern="[0-9\.]+$" title="Apenas Números e ponto. Ex: 11.1 " maxlength="6" required style=" position:relative; left:0%; width: 50%; height: 30px;" >
                           </div><br>
 
                    <div id="ajustePlace3"><input  name="preco" placeholder=" Preco com Desconto" pattern="[0-9\.]+$" title="Apenas Números e ponto. Ex: 11.1 " maxlength="6" required style=" position:relative; left:0%; width: 50%; height: 30px;" ></div>

                    <div id="ajustePlace4"><br><input  name="quantidadeEstoque" pattern="[0-9\.]+$" title="Apenas Números e ponto. Ex: 11.1" maxlength="6" placeholder=" Estoque quantidade" required style=" position:relative; left:0%; width: 50%; height: 30px;" ></div>

                    <div id="ajustePlace5"><br><input  name="medida" pattern="[0-9\.]+$" title="Apenas Números e ponto. Ex: 11.1" maxlength="6" placeholder=" Medida ex: 25.0" required style="  position:relative; left:0%; width: 50%; height: 30px;"  ></div>


                    <div id="ajustePlace6"><br><input name="unidadeMedida"  pattern="[A-z\s]+$" title="Apenas Letras" maxlength="2" placeholder=" Unidade ex: GM, L, ML" required style=" position:relative;left:0%; width: 50%; height: 30px;" ></div>


                    <div id="ajustePlace7"><br><input type="date" name="validade" pattern="[0-9][0-9][0-9][0-9]-[0-9][0-9]-[0-9][0-9]+$" title="Informe uma data válida. Ex: 2015-10-10" required maxlength="10" placeholder=" Validade ex: 2016-10-10 " style=" position:relative; left:0%; width: 50%; height: 30px;" ></div>
                    <div id="ajustePlace8"><br><input type="comprimento" name="comprimento" value="0.0" pattern="[0-9\.]+$" maxlength="6" title="Informe um valor válido. Ex: 20.50" required maxlength="10" placeholder="Comprimento  " style=" position:relative; left:0%; width: 50%; height: 30px;" ></div>
                    <div id="ajustePlace9"><br><input type="largura" name="largura" value="0.0" pattern="[0-9\.]+$" maxlength="6" title="Informe um valor válido. Ex: 20.50" required maxlength="10" placeholder=" Largura " style=" position:relative; left:0%; width: 50%; height: 30px;" ></div>
                    <div id="ajustePlace10"><br><input type="altura" name="altura" value="0.0" pattern="[0-9\.]+$"  maxlength="6" title="Informe um valor válido. Ex: 20.50" required maxlength="10" placeholder="Altura " style=" position:relative; left:0%; width: 50%; height: 30px;" ></div>
                    <div id="ajustePlace11"><br><input type="peso" name="peso" value="0.0" pattern="[0-9\.]+$" maxlength="6" title="Informe um valor válido. Ex: 20.50" required maxlength="10" placeholder="Peso " style=" position:relative; left:0%; width: 50%; height: 30px;" ></div>



                    <div id="ajustePlace12" style="text-transform: capitalize">
                        Categorias Existentes <br>
                        <select name="categoria" required style=" position: relative; left:0%; width: 50%; height: 30px;" >
                            <option>Selecione uma categoria</option>                                                                
                            <c:forEach var="produto" items="${cate.listarCategoriasForm()}">
                                <option>
                                    ${produto.categoria}
                                </option>                                            
                            </c:forEach>
                    ...
                    <div id="ajustePlace10"><br><h3>Promoção:</h3>
                        <label><font style="margin-left: 0%; font-size: 11pt" ><input type="radio" name="promocao" value="Sim"> Sim</font></label>
                        <label><font style="margin-left: 2%; font-size: 11pt"> <input type="radio" name="promocao" value="Nao"> Não</font></label>
                    </div><br>

                    <input type="submit" value="Cadastrar" title="Cadastrar o produto desejado">
                </form>


                <div id="ajustePlace9Endereco" style="text-align: center;"><br>
                    Cadastrar nova categoria
                    <br>
                    <form action="ProdutoServlet?cmd=cadastraCategoria" method="POST">
                        <input type="hidden" name="nome" value="Favor Informar">
                        <input type="hidden" name="descricao" value="Favor Informar">
                        <input type="hidden" name="descricaoCompleta" value="Favor Informar">
                        <input type="hidden" name="precoAntigo" value="0.0">
                        <input type="hidden" name="preco" value="0.0">
                        <input type="hidden" name="quantidadeEstoque" value="0.0">
                        <input type="hidden" name="medida" value="0.0">
                        <input type="hidden" name="unidadeMedida" value="Favor Informar">
                        <input type="hidden" name="validade" value="2055-10-07">
                        <input type="hidden" name="comprimento" value="0.0">
                        <input type="hidden" name="largura" value="0.0">
                        <input type="hidden" name="altura" value="0.0">
                        <input type="hidden" name="peso" value="0.0">
                        <input type="hidden" name="promocao" value="nul">                                                        
                        <input  name="categoria" placeholder="Digite a nova categoria" title="Aqui SE PRECISAR você poderá cadastrar uma nova categoria"><br><br>
                        <input type="submit" value="Cadastrar Categoria" title="Cadastrar uma nova Categoria, Não é obrigatório">                                                          
                    </form><br>
                </div>  
            </div>
        </div>
