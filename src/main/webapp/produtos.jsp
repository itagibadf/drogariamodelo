...
<html>
    <head>
        ...
        <title>Medicamentos- Pharmaluci</title>
    ...
    <body>
        ...
        <div id="conteudo">
            ...
            <div id class="titulo">
                <a href="index.jsp"><font color="black">Drogaria Pharmaluci</font></a> - <a href="ProdutoServlet?cmd=listarProdutos&categoria=${categoria}"><font color="black">Medicamentos</font></a> - <a href="ProdutoServlet?cmd=listarProdutos&categoria=${categoria}"><font color="black"><b>${categoria}</b></font></a>
            </div>
            <div id="conteudoProdutos" >
                ...
                <c:if test="${categoria == null}">
                    <script>alert('Produto não encontrado, procure por outro nome');</script>
                    <h3 style="margin-top: 4%; margin-left: 17%;">Use a lista ao lado esquerdo ou o menu para buscar o Medicamento desejado!.</h3>
                </c:if>

            </div>

            <div id="menuCategorias">
                <!--Responsável por puxar os categorias no banco de Dados-->
                <c:forEach var="produtoBanco" items="${cate.listarCategorias()}" varStatus="count">
                    <c:set var="contadorCategorias" value="${count.count}"/>   
                    ...
                    <font style="float: left; margin-left:1%; margin-top: 0.5%;  color:#999;">Produtos encontrados: ${contadorCategorias}</font><br><br>
                
            </div>
            
              

            <c:if test="${categoria != '' and idRemedio != null}">
                <div id class="filtros">

                    <h3>Filtros</h3>

                    <a href="ProdutoServlet?cmd=ordemAlfabetica&categoria=${categoria}" title="Ordem alfabética" style="color:#3d3f41;">A-z</a><br>
                    <a href="ProdutoServlet?cmd=ordemDecrescente&categoria=${categoria}" title="Ordem decrescente" style="color:#3d3f41">Z-a</a><br>
                    <a href="ProdutoServlet?cmd=dataLancamento&categoria=${categoria}" style="color:#3d3f41">Data Lançamento</a><br><br>

                    <h3>Preços</h3><p>
                        <a href="ProdutoServlet?cmd=menorPreco&categoria=${categoria}" title="Menor preço" style="color:#3d3f41">Menor preço</a><br>
                        <a href="ProdutoServlet?cmd=maiorPreco&categoria=${categoria}" style="color:#3d3f41"> Maior Preço</a><br>                    
                        <a href="ProdutoServlet?cmd=filtroPreco&categoria=${categoria}&precoInformado=10" style="color:#3d3f41">Até R$10</a><br>                                                
                        <a href="ProdutoServlet?cmd=filtroPrecoBetween&categoria=${categoria}&preco1=11&preco2=20" style="color:#3d3f41">Até R$ 11-20</a><br>                   
                        ...
                        <a href="ProdutoServlet?cmd=filtroPrecoMaior&categoria=${categoria}&precoInformado=200.0" style="color:#3d3f41">Acima de R$ 200</a>           
