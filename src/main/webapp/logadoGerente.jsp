...
<html>
    <head>
        ...
        <title>Página do(a) ${gerente.nome}</title>
    ...
    <body>
        ...
        <div id="conteudo">
            <div id class="titulo"><a href="index.jsp">Drogaria Pharmaluci</a> - <a href="#"><b>Início</b></a></div>                             
            ${mensagemErro}

            <font style="float:left; text-align: center;margin-top: 8.2%; margin-left: 18%;font-size: 12pt; text-transform: uppercase; color: black;" >
                <center><b>Bem Vindo! ${gerente.nome}.
                    <p> Este é o seu ambiente em que você pode realizar as operações disponibilizadas pelo menu logo acima.</b> 
                </center><br>
            </font>
        ...
        <div id="rodape" style="min-height: 346px">
            <div class="table">
                <h3> Menu</h3>
            ...
            <div class="table">
                ...
                <a href="#"><img src="imagem/facebook.png"  width="50px" height="40px"></a> <font style=" font-family: helvetica; font-size: 12pt; display: table;"> &raquo DrogariaPharmaluci</font>
