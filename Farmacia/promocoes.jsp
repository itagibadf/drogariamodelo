    ...
    <body>
                ...
                <a href="PedidoServlet?cmd=listarPedidosUsuario&idUsuario=${user.idUsuario}" >
                    <c:choose>
                        <c:when test="${contador != null}">
                            <div id class="imgCarrinho" title="Você possui ${contador} item(s) em seu carrinho, Total:<fmt:formatNumber type="currency" value="${total}"/> . Clique e veja.">
                                <font color="whitesmoke">${contador}</font>
                            </div>
                        </c:when>
                        <c:otherwise>
                            <div id class="imgCarrinho" title="Seu carinho está vazio.">
            ...
            <div id="busca">
                <form action="ProdutoServlet?cmd=buscar" method="POST">
                    <div id class="textoBusca">
                        <input name="nomeBusca" placeholder=" Pesquise o Medicamento desejado" required title="O que procura?"  style=' width:60%; height: 42px'>    
                    </div>
        ...
        <div class="container">
            <nav id="cbp-hrmenu" class="cbp-hrmenu">         
                <ul>
                    <li>
                        <a href="#"  id="menu"> Aparelhos e Testes</a>
                    ...
                    <li>
                        <a href="#"  id="menu3">Dermocosméticos</a>
                        <div class="cbp-hrsub">
                        ...
                        <div class="cbp-hrsub">
                            ...
                            <div class="cbp-hrsub-inner"> 
                                <div>
                                    ...
                                    <ul>
                                        <li><a href="ProdutoServlet?cmd=listarProdutos&categoria=antigripais">Antigripais</a></li>
        ...
        <div id="conteudo">            
            ...
            <div id="main">
                <div class="slider">
                    <ul>
                        <li>
                            <img id="slide" src="imagem/Produtos/ofertas/oferta8.png" />
<!--                            <span>
                                <h4>Frete Grátis</h4>
                                Na compra de qualquer medicamento, acima de R$ 100, o frete é por nossa conta.
                            </span>-->
                        </li>
                        <li>
                            <img id="slide" src="imagem/Produtos/ofertas/oferta9.png" />
<!--                            <span>
                                <h4>Desconto de 70%</h4>
                                Medicamentos Genéricos com descontos de 70%, aproveite e economize.
                            </span>-->
                        </li>
                        <li>
                            <img id="slide" src="imagem/Produtos/ofertas/oferta8.png" />
<!--                            <span>
                            ...
                            <c:if test="${user == null}">
                                ...
                                <div id class="produtoSlide" >
                                    ...
                                    <a href="ProdutoServlet?cmd=mostraProduto&idRemedio=${produto.idRemedio}" title="${produto.nome}">
                                        <img  src="imagem/Produtos/${produto.idRemedio}.jpg" width="100%" height="200px"></a>
                                    <div class="nome">
                                        ${produto.nome} 
                                    </div>
                                    <div class="preco">
                                        <hr size="1" width="100%" color="white">
                                        <div class="precoAntigo">De <fmt:formatNumber type="currency" value="${produto.precoAntigo}"></fmt:formatNumber></div>
            ...
            <div id="promocoes"><br>
                <center>Ofertas Semanais</center><br>     
                <div id="conteudoSlide">
                    <c:forEach var="produto" items="${cate.listarOfertasSemanais()}">
                        <c:if test="${user != null}">                                                     
                            <form method="POST" action="PedidoServlet?cmd=adc">                                                         </c:if>
                            <c:if test="${user == null}">
                                <form action="PedidoServlet?cmd=verificaUsuario" method="POST">
                                </c:if>
                                ...
                                <div id class="produtoSlide">
                                    ...
                                    <div class="preco">
                                        <hr size="1" width="100%" color="white">
                                        <div class="precoAntigo">De <fmt:formatNumber type="currency">${produto.precoAntigo}</fmt:formatNumber><p></div>
                                    ...
                                    <c:if test="${produto.quantidadeEstoque == 0}">
                                        <a href="ProdutoServlet?cmd=mostraProduto&idRemedio=${produto.idRemedio}" style="text-decoration: none;"><input type="button" value="+ Detalhes" style="width: 100%; height: 40px; margin-left: 0;"></a>
                                        </c:if> 
                                </div>
                            </form>
                        </form>
            ...
            <div id="rodape">
                <div class="table">
                    ...
                    &raquo <a href="#">Início<br><br></a>
                    &raquo <a href="farmacia.jsp">Drogaria<br><br></a>
                    &raquo <a href="ProdutoServlet?cmd=listarProdutos&categoria${''}"> Produtos<br><br></a>
                    &raquo <a href="ProdutoServlet?cmd=listarPromocoes#rodape">Promoções<br><br></a>
                ...
                <div class="table">
                    ...
                    <a href="#"><img src="imagem/facebook.png"  width="50px" height="40px"></a> <font style=" font-family: helvetica; font-size: 12pt; display: table;"> &raquo Pharmaluci Pharmaluci</font>
                    <a href="#"><img src="imagem/skype.png" width="50px" height="40px"></a><font style=" font-family: helvetica; font-size: 12pt; display: table;"> &raquo  DrogariaPharmaluci</font>
                    <a href="#"><img src="imagem/watsap.jpg"  width="50px" height="40px"></a><font style=" font-family: helvetica; font-size: 12pt; display: table;"> &raquo (61) 3356-8520</font>
                </div>
                <div class="table">
