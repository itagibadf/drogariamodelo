...
<html>
    ...
    <body>
        ...
        <div id="conteudo">
            <div id class="titulo" style="left: 0.4%"><a href="index.jsp">Drogaria Pharmaluci</a> - <a href="logadoGerente.jsp">Início</a> - <a href="#"><b>Pedidos Liberados</b></a></div> 
            ...
            <c:if test="${idUsuario == null}">
                ...
                <font color="black" style=" font-size: 13pt; text-align: left;"><b>&raquoNão há pedidos Liberados no momento</b></font>
                <hr size="2"  style="background:#d7d7d9; ">
            </c:if>
