...
<html>
    ...
    <body>
        ...
        <div id="conteudo" style="overflow: auto;">
            ...
            <hr size="4px" width="100%"  style="background:#d6d3d3; border:none; border-radius:3px ;">
            ...
            <c:choose>
                ...
                <c:when test="${estado == 4}">
                    ...
                    <c:otherwise>
                    <font color="black"><h2> &raquoNão há pedidos em sua lista. Monte sua lista clicando aqui -><a href="ProdutoServlet?cmd=buscar&nomeBusca=${"a"}"><input type="submit" value="+" style="float: right;margin-right: 38%; margin-top: 0%;"></a></h2></font>
