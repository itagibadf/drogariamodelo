...
<html>
    ...
    <body>
        ...
        <div id="conteudo" style="overflow: auto;">
            <div id class="titulo" style="left: 0.4%"><a href="index.jsp">Drogaria Pharmaluci</a> - <a href="logadoGerente.jsp">Início</a> - <a href="#"><b>Pedidos Pendentes</b></a></div>
            ...
            <a href="PedidoServlet?cmd=listarPedidosNegados"><font style="float:left; color: red; font-size: 14pt; margin-left: 0.5%; margin-top: 8.4%">&raquoNegados</font></a>
            <table>
                <tr>
                    <th>Nome</th>
                    <th>Sobrenome</th>
            ...
            <c:if test="${idUsuario == null}">
                ...
                <font color="black" style=" font-size: 13pt; text-align: left;"><b>&raquoNão há pedidos Pendentes no momento</b></font>
                <hr size="2"  style="background:#d7d7d9;">
            </c:if>
        </div>
        <div id="rodape" style="min-height: 350px;">
            <div class="table">
                <h3> Menu</h3>
