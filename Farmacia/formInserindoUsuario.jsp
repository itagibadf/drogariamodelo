...
<html>
    ...
    <body>
        ...
        <div id="conteudo">
            <div id class="titulo"><a href="index.jsp">Drogaria Pharmaluci</a> - <a href="logadoGerente.jsp">Início</a> - <a href="#"><b>Cadastrando Usuário</b></a></div>
            <div id="ajusteRegistro"><br>
                <form name="form1"  action="UsuarioServlet?cmd=adc" method="POST">
                    ...
                    <div id="ajustePlace1"><input  name="nome" pattern="[A-z\s]+$" title="Apenas Letras" maxlength="50" required  placeholder=" Nome" size="10" style=" position:relative; left:0%; width: 50%; height: 30px;"></div><br>

                    <div id="ajustePlace2"><input  name="sobrenome" pattern="[A-z\s]+$" title="Apenas Letras" maxlength="50" placeholder=" Sobrenome"  style=" position:relative; left:0%; width: 50%; height: 30px;" ></div>

                    <div id="ajustePlace3"> <font>Nascimento</font><br>
                        <input type="date" name="dataNascimento" pattern="[0-9][0-9][0-9][0-9]-[0-9][0-9]-[0-9][0-9]+$" title="Informe uma data válida. Ex: 2016-05-05" maxlength="10"   maxlength="10" placeholder=" ex: 2015-09-08" style=" position:relative; left:0%; width: 50%; height: 30px;"></div>
                    ...
                    <div id="ajustePlace5"><br><input  name="login" placeholder=" Nome de Login" maxlength="35" style=" position:relative; left:0%; width: 50%; height: 30px;"></div>

                    <div id="ajustePlace6"> <br><input type="email" name="email" placeholder=" Email@tipo.com" maxlength="50" style=" position:relative; left:0%; width: 50%; height: 30px;"></div>
                    ...
                    <!--                    Setando um valor nna variável Tipo para que o usuário cadastre apenas usuarios de seu
                                          tipo 1-->

                    <input type="hidden" name="tipo" value="1" readonly="readonly" /><br>

                    <!--                     Botões do java script -->
                    <input type="submit" value="Cadastrar" style=" position:relative; ">
                </form><br>
            </div>
        </div>
        <div id="rodape">
