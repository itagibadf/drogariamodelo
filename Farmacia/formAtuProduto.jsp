<%--
    ...
    Author     : itagiba
--%>
<!--Importando a lista e as classes para utilização impotante para puxar alguma DAO para o jsp-->
...
<html>
    <head>
        ...
        <title>Atualizar ${produto.nome}</title>
    ...
    <body>
        ...
        <div id="conteudo">
            <div id class="titulo" style=" width: auto"><a href="index.jsp">Drogaria Pharmaluci</a> - <a href="logadoGerente.jsp">Início</a> - <a href="#"><b>Atualizando ${produto.nome}</b></a></div>
            <div id="ajusteRegistro"><br>
                <form name="form1"  action="ProdutoServlet?cmd=atualizar" method="post">
                    <br>
                    <font style=" position: relative;  font-family: Tahoma;  font-size:14pt; color:#de313f;"><center><b>Atualizando Produto</b></center></font><br>
                    <center><a href="imagem/Produtos/${produto.idRemedio}.jpg" title="${produto.nome}"><img src="imagem/Produtos/${produto.idRemedio}.jpg" width="40%" height="auto" style="border:1px solid #dddada;"></a></center><br>

                    <!--Puxando o Id_usuario para que ele não possa digitar, facilitando o processo. -->
                    <input type="hidden" name="idRemedio" value="${produto.idRemedio}" readonly="readonly" style=" display: none;"/>



                    <div id="ajustePlace1">
                        <font><center>Nome</center></font>                    
                        <input  name="nome" required   value="${produto.nome}" placeholder="Nome" style=" position:relative; left:0%; " ></div>

                    <div id="ajustePlace2">Descrição<br>
                        <textarea name="descricao" maxlegnth="200" style=" position:relative; left:0%; max-width: 50%; min-width: 50%; max-height: 160px;" >${produto.descricao}</textarea></div>
                        <div id="ajustePlace3">Bula<br>
                            <textarea name="descricaoCompleta" maxlegnth="9000" style=" position:relative; left:0%; max-width: 50%; min-width: 50%; max-height: 160px;" >${produto.descricaoCompleta}</textarea>                        
                        </div>
                        <div id="ajustePlace3">
                            Preço Atual<p>
                         <input  name="precoAntigo" required   value="${produto.precoAntigo}" placeholder="Preço Atual" style=" position:relative; left:0%;  " >
                        </div>
                    <div id="ajustePlace3"><center>Preço Desconto</center>
                        <input  name="preco" required   value="${produto.preco}" placeholder="Preço com Desconto" style=" position:relative; left:0%;  " ></div>


                    <div id="ajustePlace4">
                        <font>Estoque</font><br>
                        <input name="quantidadeEstoque" placeholder="Quantidade em estoque" value="${produto.quantidadeEstoque}" maxlength="10" style=" position:relative; left:0%;  "></div>


                    <div id="ajustePlace5">
                        <font>Medida</font><br>
                        <input  name="medida" placeholder="Quantidade" value="${produto.medida}"style=" position:relative; left:0%; "></div>


                    <div id="ajustePlace6">
                        <font >Unidade Medida</font><br><input name="unidadeMedida"  placeholder="Marca" value="${produto.unidadeMedida}" style="position:relative; left:0%; "></div>

                    <div id="ajustePlace7">
                        <font>Validade</font><br><input  name="validade" placeholder="Medida" pattern="[0-9][0-9][0-9][0-9]-[0-9][0-9]-[0-9][0-9]+$" maxlength="10" title="Informe uma data válida. Ex: 2016-10-10" value="${produto.validade}" style="  position:relative; left:0%;  "></div>
                    <div id="ajustePlace8">
                        <font>Comprimento</font><br><input  name="comprimento" placeholder="Comprimento" pattern="[0-9\.]+$" maxlength="6" title="Iforme um valor válido. Ex: 20.50" value="${produto.comprimento}" style="  position:relative; left:0%;  "></div>

                    <div id="ajustePlace9">
                        <font>Largura</font><br><input  name="largura" placeholder="Largura" pattern="[0-9\.]+$" maxlength="6" title="Iforme um valor válido. Ex: 20.50" value="${produto.largura}" style="  position:relative; left:0%;  "></div>

                    <div id="ajustePlace10">
                        <font>Altura</font><br><input  name="altura" placeholder="Altura" pattern="[0-9\.]+$" maxlength="6" title="Iforme um valor válido. Ex: 20.50" value="${produto.altura}" style="  position:relative; left:0%;  "></div>

                    <div id="ajustePlace11">
                        <font>Peso</font><br><input  name="peso" placeholder="Peso" pattern="[0-9\.]+$" maxlength="6" title="Iforme um valor válido. Ex: 20.50" value="${produto.peso}" style="  position:relative; left:0%;  "></div>


                    <div id="ajustePlace12"><br>
                        <font >Categorias Existentes</font><br>
                        <select name="categoria" style=" position:relative; left:0%; width:50%;text-transform: capitalize;">
                            <option value="${produto.categoria}" selected="true">${produto.categoria}</option>
                            <c:forEach var="produtoBanco" items="${cate.listarCategoriasForm()}">
                                <option value="${produtoBanco.categoria}">  ${produtoBanco.categoria}</option>
                            </c:forEach>
                    ...
                    <div id="ajustePlace13" style="text-align: center; margin-top: 1%;"><h3>Promoção:</h3>
                        <label><font style="margin-left: 0%; font-size: 11pt" ><input type="radio" name="promocao" checked value="Sim"> Sim</font></label>
                        <label><font style="margin-left: 2%; font-size: 11pt"> <input type="radio" name="promocao"   value="Nao"> Não</font></label>
                    </div><br>
                    <input type="submit" value="Atualizar" title="Atualizar produto"> 
                </form><br>
                <div id="ajustePlace9Endereco" style="text-align: center;">
                    <form action="ProdutoServlet?cmd=atualizarCategoria" method="POST">
                        ...
                        <input type="submit" value="Cadastrar Categoria" title="Cadastrar uma nova categoria">                                                          
                        </div>  
