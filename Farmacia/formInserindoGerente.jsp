<%--
    Document   : registro
    Created on : 25/08/2015, 10:50:25
    Author     : itagiba
--%>
...
<html>
    ...
    <body>
        ...
        <div id="conteudo" style="overflow: auto"> 
            <div id class="titulo"><a href="index.jsp">Drogaria Pharmaluci</a> - <a href="logadoGerente.jsp">Início</a> - <a href="#"><b>Cadastrando Gerente</b></a></div>
            <div id="ajusteRegistro"><br>
                <form name="form1"  action="UsuarioServlet?cmd=adcGerente" method="POST">

                    <font style=" position: relative;  font-family: Tahoma;  font-size:14pt; color:#de313f;"><center><b>Cadastro de Gerente</b></center></font><br>
                    <!--Puxando o Id_usuario para que ele não possa digitar, facilitando o processo. -->
                    <div id="ajustePlace1"><input  name="nome" required pattern="[A-z\s]+$" title="Apenas Letras" maxlength="50" placeholder=" Nome" size="10" style=" position:relative; left:0%; width: 50%; height: 30px;"></div><br>

                    <div id="ajustePlace2"><input  name="sobrenome" placeholder=" Sobrenome" pattern="[A-z\s]+$" title="Apenas Letras" maxlength="50" style=" position:relative; left:0%; width: 50%; height: 30px;" ></div>

                    <div id="ajustePlace3"> <font>Nascimento</font><br>
                        <input type="date" name="dataNascimento"  pattern="[0-9][0-9][0-9][0-9]-[0-9][0-9]-[0-9][0-9]+$" title="Informe uma data válida. Ex: 2016-06-06" maxlength="10" placeholder=" ex: 2015-09-08" style=" position:relative; left:0%; width: 50%; height: 30px;"></div>
