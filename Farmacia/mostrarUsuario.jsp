...
<html>
    ...
    <body>
        ...
        <div id="conteudo">
            <div id class="titulo" style="left: 0.4%;"><a href="index.jsp">Drogaria Pharmaluci</a> - <a href="logadoGerente.jsp">Início</a> - <a href="#"><b>Mostrar Usuários</b></a></div>
            <td> <a href="formInserindoUsuario.jsp"><input type="submit" value="+" ></a></td>
            <table>
                ...
                <c:forEach var="lista" items="${ requestScope.usuarioList }">
                    <tr>
                        ...
                        <td>${lista.cpf}</td>
                        <td>${lista.cidade}</td>
                        <td><textarea readonly="readonly" style="max-width: 100%; background: white;max-height: 100px;">${lista.endereco}</textarea></td>
                        <td>${lista.cep}</td>
                        <td>${lista.tipo}</td>
                        <td>
                            <!--                    Usuário Servlet que puxa os campos dos usuários para serem atualizados-->
                            <a href="UsuarioServlet?cmd=atu&idUsuario=${lista.idUsuario}"><input type="submit" value="Edit"> </a>

                        </td>
                        <td>
                            <form method="POST" action="UsuarioServlet?cmd=exc">
                                <input type="hidden" name="idUsuario" value="${lista.idUsuario}">
                                <input type="password" name="senhaAdmin" placeholder="Senha" style=" position: relative;left: 1%;" required>
        ...
        <div id="rodape">
            <div class="table">
                ...
                &raquo <a href="index.jsp">Início</font><br><br></a>
